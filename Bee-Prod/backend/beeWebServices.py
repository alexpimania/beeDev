...
application = tornado.web.Application([
    ...
    (r"/refreshIconMoving.gif()", tornado.web.StaticFileHandler, {'path': BEE_PATH + '/refreshIconMoving.gif'}),
    (r"/closeIcon.png()", tornado.web.StaticFileHandler, {'path': BEE_PATH + '/closeIcon.png'}),
], ssl_options={
